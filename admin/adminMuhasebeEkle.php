<?php 
    ...
    dosyaEkle(3,"muhasebe","adminMuhasebeListele");
?>
    <div class="container pt-5">
        <div class="card p-5">
        <form action="<?= htmlspecialchars('./adminMuhasebeEkle.php')?>" method="POST" enctype="multipart/form-data">
            <h3 class="text-center pb-3">Muhasebe Ekle</h3>
